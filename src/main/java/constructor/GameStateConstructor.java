...
@Slf4j public class GameStateConstructor {
  @Getter private static CategoriesEnum categories;
  @Getter private static Difficulty difficulty;
  private static GameState gameState;
  @Getter static FileWordRepository fileWordRepository = new FileWordRepository();
